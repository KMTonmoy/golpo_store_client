...
const NavbarBottom = ({ cartCount, isLoggedIn, setIsLoggedIn, setCartCount }: NavbarBottomProps) => {
              ...
              {[
                ...
                <motion.div key={item.name} className="relative group">
                  <motion.a
                    href={item.href}
                    whileHover={{ y: -2 }}
                    className="text-gray-700 hover:text-accent transition-colors font-medium flex items-center space-x-2 text-sm"
                  >
